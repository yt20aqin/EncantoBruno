...
public class rodolfosanchez : MonoBehaviour, IUnityAdsInitializationListener, IUnityAdsLoadListener, IUnityAdsShowListener
{

    public string victoriaconnell;
    public GameObject esperanzagillis;

    #region AdMob
    [Header("Admob")]
    public string ernalowry = "";
    public string carolrosario = "";
    public string daniellehoffman = "";

    #endregion
    [Space(15)]
    #region
    [Header("UnityAds")]
    public string angelinechase;
    public string unityAdsVideoPlacementId = "rewardedVideo";
    #endregion

    static rodolfosanchez instance;

    public static int unlockID;
    public static merrillbeltran itemToUnlock;

    public static rodolfosanchez Instance
    {
        get
        {
            if (instance == null)
                instance = GameObject.FindObjectOfType(typeof(rodolfosanchez)) as rodolfosanchez;
    ...
    public void VideoRewarded()
    {
        ...
        shanemccollum.francismcgovern.Add(unlockID);
        shanemccollum.earlenemanley();
    }
    ...
    {
        if (this.diannastephens)
        {
            this.interstitialAd.Show();
            this.diannastephens = false;
