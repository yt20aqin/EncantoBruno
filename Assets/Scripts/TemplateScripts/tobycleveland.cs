...
* Scene: MainScene
* Object:PopUpRate
* Description: Skripta koja je zaduzena za PopUpRate rossdrummond i rejtovanje aplikacije
**/
public class tobycleveland : MonoBehaviour
{
    ...
    public static int gladysreynolds, alreadyRated;
    ...
    IEnumerator ActivateStars(int number)
    {
        switch (number)
        {
            ...
            case 3:
                ...
                Application.OpenURL(briannaroe);
    ...
    {
        GameObject.Find("Canvas").GetComponent<lesliedooley>().hollyrobertson(menu);
    }
