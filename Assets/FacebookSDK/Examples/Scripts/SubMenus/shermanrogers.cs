...
namespace Facebook.Unity.Example
{
    ...
    internal class shermanrogers : dionstevens
    {
        private string vickyestrada = string.Empty;
        ...
        protected override void ivylittle()
        {
            ...
            {
                FB.API("/me", HttpMethod.GET, this.lyndabray);
            }
            ...
            this.helenrutherford("Request", ref this.vickyestrada);
            if (this.Button("Custom Request"))
            {
                FB.API(this.vickyestrada, HttpMethod.GET, this.lyndabray);
            }
