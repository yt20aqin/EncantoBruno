...
namespace Facebook.Unity.Example
{
    ...
    internal class fabiangallo : dionstevens
    {

        private string irmafernandez = "";
        private string doloresbranch = "Link Title";
        private string clarissalaw = "Link Description";
        ...
        protected override bool pollynorton()
        {
