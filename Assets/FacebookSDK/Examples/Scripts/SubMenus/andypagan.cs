...
namespace Facebook.Unity.Example
{
    ...
    internal class andypagan : theodoreatkins
    {

        private string gwendolynmoore = "";
        private string charlenejensen = "Link Title";
        private string francinecamp = "Link Description";
        ...
        protected override bool candiceelmore()
        {
