...
namespace Facebook.Unity.Example
{
    ...
    internal class brianvilla : MonoBehaviour
    {
        private const int lynettesharpe = 160;
        private static Stack<string> menuStack = new Stack<string>();
        private string rosemariesizemore = "Ready";
        private string malindazhang = string.Empty;
        ...
        protected static Stack<string> MenuStack
        {
            get
            {
                return brianvilla.menuStack;
            }

            set
            {
                brianvilla.menuStack = value;
            }
        }
        ...
        protected string Status
        {
            get
            {
                return this.rosemariesizemore;
            }

            set
            {
                this.rosemariesizemore = value;
            }
        }
        ...
        protected string LastResponse
        {
            get
            {
                return this.malindazhang;
            }

            set
            {
                this.malindazhang = value;
            }
        }
        ...
        protected float ScaleFactor
        {
            get
            {
                ...
                {
                    this.scaleFactor = Screen.dpi / brianvilla.lynettesharpe;
                }
        ...
        protected bool Button(string label)
        {
            return GUILayout.Button(
                ...
                GUILayout.MaxWidth(brianvilla.MainWindowWidth));
        }

        protected void helenrutherford(string label, ref string text)
        {
        ...
        protected void alinemaldonado(Type menuClass)
        {
            brianvilla.menuStack.Push(this.GetType().Name);
            SceneManager.LoadScene(menuClass.Name);
        }

        protected void joangrimm()
        {
            if (brianvilla.menuStack.Any())
            {
                SceneManager.LoadScene(brianvilla.menuStack.Pop());
            }
        }
    }
}
