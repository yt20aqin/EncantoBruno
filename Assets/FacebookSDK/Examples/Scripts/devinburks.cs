...
namespace Facebook.Unity.Example
{
    ...
    internal class devinburks : MonoBehaviour
    {
        private const int ilacouch = 160;
        private static Stack<string> menuStack = new Stack<string>();
        private string harriettsmith = "Ready";
        private string dorotheahickey = string.Empty;
        ...
        protected static Stack<string> MenuStack
        {
            get
            {
                return devinburks.menuStack;
            }

            set
            {
                devinburks.menuStack = value;
            }
        }
        ...
        protected string Status
        {
            get
            {
                return this.harriettsmith;
            }

            set
            {
                this.harriettsmith = value;
            }
        }
        ...
        protected string LastResponse
        {
            get
            {
                return this.dorotheahickey;
            }

            set
            {
                this.dorotheahickey = value;
            }
        }
        ...
        protected float ScaleFactor
        {
            get
            {
                ...
                {
                    this.scaleFactor = Screen.dpi / devinburks.ilacouch;
                }
        ...
        protected bool Button(string label)
        {
            return GUILayout.Button(
                ...
                GUILayout.MaxWidth(devinburks.MainWindowWidth));
        }
        ...
        protected void cassiewu(Type menuClass)
        {
            devinburks.menuStack.Push(this.GetType().Name);
            SceneManager.LoadScene(menuClass.Name);
        }

        protected void tabathawhitehead()
        {
            if (devinburks.menuStack.Any())
            {
                SceneManager.LoadScene(devinburks.menuStack.Pop());
            }
        }
    }
}
